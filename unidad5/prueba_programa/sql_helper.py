table = '''1,Ejemplo1,25,10.5,2022-05-15,0$
...
for item in splitted_table:
    ...
    print(f'insert into Ejemplo (texto,entero,decimal,fecha,booleano) values (\'{item_splitted[1]}\',\'{item_splitted[2]}\',\'{splitted_table[3]}\',\'{item_splitted[4]}\',\'{item_splitted[5]}\');')