...
```sql
select * from clientes as c left join ordenes as o on c.id_cliente = o.id_cliente union all select * from clientes as c right join ordenes as o on o.id_cliente = c.id_cliente;                                               
```
